...
class ProcessJobCompletedPipeline {
    ...
    sendSlackMessage(_, input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            messages.push(`Build Time: *${(0, dayjs_1.default)(input.event.job.stopped_at).unix() - (0, dayjs_1.default)(input.event.job.started_at).unix()} seconds*`);
    ...
    run() {
        ...
        new pipeline_1.WaterfallPipeline(new pipeline_1.Context(), input)
            ...
            .run()
            .catch(error => logger_1.default.error(error.messages));
    }
}
module.exports = ProcessJobCompletedPipeline;
//# sourceMappingURL=process-job-completed.pipeline.js.map