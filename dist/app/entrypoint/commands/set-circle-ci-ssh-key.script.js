...
//ts-node src/app/entrypoint/commands/set-circle-ci-ssh-key.script.ts --project=user-service --sshKey="privateKeyHere"
...
function processSSHKey(project, argv) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const createSSHKeyResponse = yield circleciService.createSSHKey(vcsSlug, {
            hostname: argv.hostname,
            private_key: argv.sshKey
        });
        console.log("sshKeyResponse", createSSHKeyResponse);
    });
}
execute();
//# sourceMappingURL=set-circle-ci-ssh-key.script.js.map